...
2. Middleware (Flask framework): A lightweight Flask server acts as middleware. It receives email RAW content in JSON, invokes the APOLLO Python model, and returns the classification result also in JSON format.
